# Welcome to contributing at Aider Pack Manager.🤝
...
To get an overview of the project, read the [README](https://github.com/lucacri/aider-pack#readme).

## Issues

### Create a new issue

If you spot a problem, search if that issue already exists.
